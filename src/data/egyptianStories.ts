...
export interface StoryPanel {
  ...
  export const egyptianStories: Story[] = [
    ...
    {
      id: 'imhotep-vision',
      title: "Imhotep's Vision",
      subtitle: 'The Birth of Eternity in Stone',
      period: 'Old Kingdom',
      periodId: 'old-kingdom',
      type: 'historical',
      description: 'Follow the genius architect Imhotep as he conceives and builds the first pyramid - the Step Pyramid at Saqqara. A tale of divine inspiration, revolutionary engineering, and the dawn of monumental architecture.',
      themes: ['Innovation', 'Divine Inspiration', 'Legacy', 'Service to the King'],
      relatedLocations: ['saqqara', 'memphis'],
      puzzleIds: ['pyramid-blocks', 'architect-riddle'],
      estimatedReadTime: 15,
      characters: [
        {
          id: 'imhotep',
          name: 'Imhotep',
          egyptianName: 'Ii-m-ḥtp',
          role: 'Royal Architect & Vizier',
          description: 'A man of humble origins who rose to become the most celebrated genius of ancient Egypt. Architect, physician, astronomer, and sage.',
          traits: ['Brilliant', 'Humble', 'Visionary', 'Devoted']
        },
        {
          id: 'djoser-story',
          name: 'King Djoser',
          ...
          role: 'Pharaoh',
          description: 'The Third Dynasty king who dared to dream of a tomb that would touch the sky.',
          traits: ['Ambitious', 'Wise', 'Trusting']
        },
        {
          id: 'khentika',
          name: 'Khentika',
          role: 'Master Mason',
          description: 'Skeptical foreman of the construction crews who must be convinced that stone can replace mud brick.',
          traits: ['Practical', 'Stubborn', 'Skilled']
        }
      ],
      panels: [
        {
          id: 'iv-1',
          imagePrompt: 'Ancient Egyptian sunrise over Memphis, realistic historical illustration. Imhotep stands on a rooftop gazing at traditional mud-brick mastaba tombs in the distance. Early morning light, dust motes in the air. He wears the white robes of a high official. Photorealistic, detailed, historically accurate.',
          narration: 'In the thirtieth year of King Djoser\'s reign, Imhotep stood before dawn, troubled by a recurring dream. The king had commanded a tomb greater than any before - but how could mud brick ever touch eternity?',
          historicalNote: 'Before Imhotep, all tombs were mastabas - flat-topped mud brick structures that crumbled within centuries.'
        },
        {
          id: 'iv-2',
          imagePrompt: 'Interior of ancient Egyptian temple, Imhotep kneeling before a statue of Ptah the creator god. Flickering oil lamps, hieroglyphic walls, incense smoke. The statue has a gilded face. Realistic historical painting style.',
          narration: 'He sought wisdom at the temple of Ptah, the craftsman god who shaped the world on his potter\'s wheel.',
          dialogue: [
            { speaker: 'Imhotep', text: 'Great Ptah, show me how to build for eternity. How can mortal hands craft what the ages cannot destroy?' }
          ],
          historicalNote: 'Ptah was the patron god of craftsmen and was believed to have created the world through thought and speech.'
        },
        {
          id: 'iv-3',
          imagePrompt: 'Dramatic vision scene - Imhotep in trance seeing a geometric vision of stacked stone mastabas forming a step pyramid, glowing with golden light against a dark background. Realistic but mystical, ancient Egyptian style.',
          narration: 'And Ptah answered in a vision: stone upon stone, mastaba upon mastaba, rising in steps toward the realm of the gods.',
          dialogue: [
            { speaker: 'Voice of Ptah', text: 'Look to the eternal stone, my son. Stack the earth toward heaven. What is one shall become six, and your king shall climb to the stars.' }
          ]
        },
        {
          id: 'iv-4',
          imagePrompt: 'Ancient Egyptian quarry at Tura, workers cutting limestone blocks with copper tools, supervisors measuring with ropes and measuring rods. Harsh sunlight, dust clouds, laborers in loincloths. Realistic historical painting.',
          narration: 'The white limestone of Tura would be his canvas. But first, Imhotep had to convince the master masons that stone could be worked like mud brick - only they laughed.',
          dialogue: [
            { speaker: 'Khentika', text: 'Stone for a tomb? The gods gave us mud and straw, and that was good enough for our fathers!' },
            { speaker: 'Imhotep', text: 'And where are your fathers\' tombs now, Khentika? I have seen them - crumbled, forgotten, returned to the earth.' }
          ]
        },
        {
          id: 'iv-5',
          imagePrompt: 'Construction of the Step Pyramid at Saqqara, realistic historical illustration. Ramps, levers, thousands of workers, stone blocks being dragged on sledges with water poured ahead. Imhotep directing from a raised platform. Epic scale, atmospheric dust and heat.',
          narration: 'For nineteen years they labored. Six times Imhotep expanded the design, each time adding another step toward heaven. The workers no longer laughed - they sang hymns to the architect who had shown them eternity.',
          historicalNote: 'The Step Pyramid went through at least six design phases, growing from a simple mastaba to its final form.'
        },
        {
          id: 'iv-6',
          imagePrompt: 'Completed Step Pyramid at Saqqara gleaming in white limestone, Imhotep and King Djoser viewing it at sunset. The pyramid casts long shadows across the desert. Golden hour light, realistic historical painting with emotional depth.',
          narration: 'When the last stone was placed, King Djoser wept. He had his stairway to the stars. And Imhotep had given Egypt the gift of eternity.',
          dialogue: [
            { speaker: 'Djoser', text: 'You have made me immortal, Imhotep. What reward can I offer you?' },
            { speaker: 'Imhotep', text: 'Let me be remembered only as your servant, my king. The work itself is my reward.' }
          ],
          historicalNote: 'Imhotep was later deified, one of the very few non-royal Egyptians to be worshipped as a god.'
        }
      ]
    },
    {
