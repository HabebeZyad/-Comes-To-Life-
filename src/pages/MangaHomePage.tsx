...
import episode3Cover from '@/assets/manga/ep3-cover.jpg';
import episode4Cover from '@/assets/manga/ep3-cover.jpg'; // Placeholder
import episode5Cover from '@/assets/manga/ep3-cover.jpg'; // Placeholder
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="font-body text-xl text-muted-foreground max-w-3xl mx-auto">
            An anthology of interactive manga where your choices forge the destiny of Ancient Egypt.
          </p>
        </motion.header>
