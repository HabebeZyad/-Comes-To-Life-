...
import { storytellingEpisode3 } from '@/data/storytellingEpisode3';
...
const panelImages: Record<string, string> = {
  ...
  'ep3-panel-4': panel4,
  'ep3-panel-5': panel5,
  'ep3-panel-6': panel4, // Re-using panels for branching paths
  'ep3-panel-7a': panel4,
  'ep3-panel-7b': panel3,
  'ep3-panel-7c': panel2,
  'ep3-panel-8': panel1,
  'ep3-panel-9': panelCover,
  'ep3-panel-10': panelCover,
};

export default function StorytellingEpisode3() {
  ...
  const [panelHistory, setPanelHistory] = useState<string[]>(['ep3-panel-1']);

  const episode = storytellingEpisode3;
  ...
  const isLastPanel = currentPanel.id === 'ep3-panel-10';
      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-background/90 backdrop-blur-lg border-b border-border">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="text-center">
            <span className="font-display text-sm text-muted-foreground hidden sm:block">Episode 3</span>
            <span className="font-display text-lg text-gold-gradient">The Scribe Who Lied</span>
          </div>
