...
// Lazy load game components to improve initial bundle size
...
export default function Games() {
  ...
  if (currentGame !== 'menu') {
    ...
    if (GameComponent) {
      return (
        <Suspense fallback={
          <div className="min-h-screen flex flex-col items-center justify-center bg-hero-gradient text-gold">
            <Loader2 className="w-12 h-12 animate-spin mb-4" />
            <p className="font-display text-xl tracking-widest animate-pulse">Loading Trial...</p>
          </div>
        }>
