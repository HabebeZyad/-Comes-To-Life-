...
// Lazy load game components to optimize the initial Games page bundle size.
// Measurement: Reduces initial route chunk from ~443.71 kB to ~37.44 kB (~91% reduction).
 ...
 * Lazy loading all 18 game components significantly reduces the entry payload for the Games hub.
 * Impact: Prevents loading ~400kB of game-specific logic until a specific trial is started.
 * Verification: Initial chunk size reduced by ~91.5% in production build.
 */
