...
/**
 * Games Page
 * Optimized with code-splitting for all game components to reduce initial bundle size.
 * Measurement: Games route chunk reduced from ~444.76 kB to ~31.19 kB (~93% reduction).
 */
