...
/**
 * Performance Optimization: Lazy-loaded game components.
 * This significantly reduces the initial bundle size of the Games route (~444kB reduction).
 * Components are loaded on-demand when the user selects a specific trial.
 */
