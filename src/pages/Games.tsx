        ...
        <Suspense fallback={
          <div className="min-h-screen flex items-center justify-center bg-hero-gradient">
            <div className="text-center">
              ...
              <p className="font-display text-2xl text-gold-gradient">Loading Trial...</p>
            </div>
          </div>
        }>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {showLeaderboard && (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="mb-12">
            <Suspense fallback={
              <div className="h-96 flex items-center justify-center bg-black/20 rounded-2xl border border-white/10">
