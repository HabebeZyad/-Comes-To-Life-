...
// Optimized: Component-level code splitting for games to reduce Games page bundle size
...
const GameLoader = () => (
  <div className="min-h-screen bg-hero-gradient flex flex-col items-center justify-center gap-4">
    <Loader2 className="w-12 h-12 text-primary animate-spin" />
    <p className="font-display text-primary tracking-widest animate-pulse uppercase">Loading Trial...</p>
  </div>
);
