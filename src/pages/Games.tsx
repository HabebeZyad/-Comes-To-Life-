...
// Component-level code splitting for game components to reduce initial bundle size
// Impact: Reduces the 'Games' page entry chunk size significantly by deferring 18+ game implementations.
