...
import { Brain, Map, Building, Languages, Timer, Sailboat, Bug, Trophy, Crown, Clock, Users, Star, ChevronRight, BookOpen, Loader2 } from 'lucide-react';
import { EgyptianCard } from '@/components/ui/EgyptianCard';
import { EgyptianButton } from '@/components/ui/EgyptianButton';
import { Leaderboard } from '@/components/games/Leaderboard';
import { DustParticles } from '@/components/effects/DustParticles';

// Lazy load game components to reduce initial bundle size and Games portal entry cost
...
// Map of game IDs to lazy-loaded components
        ...
        <Suspense fallback={
          <div className="min-h-screen flex items-center justify-center bg-background">
            <div className="text-center">
              ...
              <p className="text-gold font-display text-xl uppercase tracking-widest">Loading Trial...</p>
            </div>
          </div>
        }>
