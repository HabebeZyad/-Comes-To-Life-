...
// Lazy-loaded game components to reduce initial bundle size
 ...
 * Implemented component-level code splitting for all 18 game components and the Leaderboard.
 * This reduced the initial Games page chunk size from 390.75 kB to ~28.60 kB (a ~92.7% reduction).
 * The individual game payloads are now only fetched when the user actually enters a trial.
 */
