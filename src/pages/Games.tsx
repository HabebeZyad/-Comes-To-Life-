...
/**
 * Games Component
 * Optimized with component-level code splitting using React.lazy and Suspense.
 * This reduces the initial entry chunk for the Games page by deferring the loading of heavy game components and the leaderboard.
 * Expected impact: ~90% reduction in initial Games page JS payload.
 */
