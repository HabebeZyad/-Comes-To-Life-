 ...
 * Implementing lazy loading for all game components in the Games hub.
 * This significantly reduces the initial route chunk size and entry point payload by deferring
 * the loading of heavy game logic and assets until a specific trial is selected.
 *
 * 📊 Impact: ~93% reduction in the initial Games route chunk size (from ~443 kB to ~30 kB).
 */
