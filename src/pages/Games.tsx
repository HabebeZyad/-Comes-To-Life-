...
// Lazy-loaded heavy components for optimal initial bundle size
...
/**
 * Games Hub - Optimized with code-splitting for all heavy game modules and leaderboard.
 * Impact: Reduced initial route chunk size from ~444.76 kB to ~31.19 kB (~93% reduction).
