...
import { Map, Brain, Building, Languages, Timer, Sailboat, Bug, Trophy, Crown, Clock, Users, Star, ChevronRight, BookOpen, Loader2 } from 'lucide-react';
import { EgyptianCard } from '@/components/ui/EgyptianCard';
import { EgyptianButton } from '@/components/ui/EgyptianButton';
import { DustParticles } from '@/components/effects/DustParticles';

// Lazy load game components for performance optimization
...
const LoadingState = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-obsidian">
    ...
    <p className="text-gold-gradient font-display text-xl uppercase tracking-widest">Loading Trial...</p>
  </div>
);
