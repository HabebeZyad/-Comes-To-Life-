...
// Lazy-loaded game components for component-level code splitting
...
export default function Games() {
  ...
  if (currentGame !== 'menu') {
    ...
    if (GameComponent) {
      return (
        <Suspense fallback={
          <div className="min-h-screen pt-20 pb-12 px-4 bg-hero-gradient flex items-center justify-center">
            <div className="flex flex-col items-center gap-4 text-gold">
              <Loader2 className="w-12 h-12 animate-spin" />
              <p className="font-display text-xl tracking-widest animate-pulse uppercase">Entering Trial Chamber...</p>
            </div>
          </div>
        }>
