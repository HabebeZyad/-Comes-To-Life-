...
// Lazy load game components to optimize bundle size
...
export default function Games() {
  ...
  if (currentGame !== 'menu') {
    ...
    if (GameComponent) {
      return (
        <Suspense fallback={
          <div className="min-h-screen pt-20 flex flex-col items-center justify-center bg-background">
            <Loader2 className="w-12 h-12 text-primary animate-spin mb-4" />
            <p className="text-gold font-display tracking-widest animate-pulse">Loading Trial...</p>
          </div>
        }>
