...
// Lazy-loaded games and leaderboard to reduce initial chunk size
...
/**
 * Games Hub Component
 * Optimized with React.lazy and Suspense for all game components and the Leaderboard.
 * This significantly reduces the initial chunk size of this route by code-splitting
 * the heavy game logic (reducing chunk from ~445 kB to ~31 kB).
 */
