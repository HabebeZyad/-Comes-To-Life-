...
// Component-level code splitting for game components to reduce initial chunk size
...
/**
 * Games Component
 * Optimized with component-level code splitting for all individual games and the leaderboard.
 * This reduced the initial Games page chunk size from ~391.28 kB to ~30 kB,
 * deferring the loading of heavy game logic until the user selects a specific trial.
 */
  ...
  return (
    <div className="min-h-screen pt-20 pb-28 md:pb-12 px-4 bg-hero-gradient relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {showLeaderboard && (
          <Suspense fallback={<PageLoader className="h-96 rounded-lg border border-gold/20 mb-12" />}>
