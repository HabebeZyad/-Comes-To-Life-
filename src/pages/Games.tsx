...
// Lazy load game components to reduce initial Games page bundle size
...
/**
 * ⚡ Bolt Optimization: Lazy Loading Game Components
 *
 * 💡 What: Replaced direct imports of 17+ game components with React.lazy.
 * 🎯 Why: The Games page bundle was ~443 kB. By lazy loading the individual games,
 *    we reduce the initial bundle size significantly, only loading game code when selected.
 * 📊 Impact: Expected reduction in initial Games page chunk size by ~90% (~400 kB reduction).
 * 🔬 Measurement: Compare 'Games-[hash].js' size in 'pnpm build' output before/after.
 */
