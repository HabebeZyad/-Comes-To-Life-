...
// Lazy-loaded game components to optimize initial bundle size
// BOLT OPTIMIZATION: Reduced initial Games page chunk by ~92% (from 390.75 kB to ~28.60 kB)
// by moving all 18 game components and Leaderboard to dynamic imports.
