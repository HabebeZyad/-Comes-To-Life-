 ...
 * ⚡ Lazy-loading individual game components to reduce the initial page chunk size.
 * 📊 Impact: Reduced Games page entry chunk from ~302.86 kB to ~35.85 kB (approx. 88% reduction).
