...
// Component-level code splitting for games using consistent .then() pattern for named exports
...
const GuessThePharaohGame = lazy(() => import('@/components/games/GuessThePharaohGame')); // Default export only
