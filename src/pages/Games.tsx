...
const gameComponents: Record<GameType, ComponentType<{ onBack: () => void }> | null> = {
  menu: null,
  memory: MemoryGame,
  maze: MummyMazeGame,
...
const GameLoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-hero-gradient relative">
    <div className="text-center z-10">
      <Loader2 className="w-12 h-12 text-primary animate-spin mx-auto mb-4" />
      <h2 className="text-2xl font-display text-gold-gradient animate-pulse">Entering Divine Trial...</h2>
    </div>
