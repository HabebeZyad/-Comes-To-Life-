...
import { Trophy, Star, ChevronRight, Timer, Map, Languages, Bug, Brain, Clock, Users, BookOpen, Crown, Sailboat } from 'lucide-react';
...
// Standardizing on the .then(m => ({ default: m.ExportName })) pattern for named exports
...
const GuessThePharaohGame = lazy(() => import('@/components/games/GuessThePharaohGame')); // Default export
