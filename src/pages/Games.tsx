...
// Lazy-loaded game components for performance optimization
// This reduces the initial Games page chunk size significantly
...
/**
 * Games Page - Optimized with component-level code splitting.
 *
 * Performance Optimization:
 * - Implemented React.lazy and Suspense for all game components.
 * - Impact: Reduced initial Games route chunk size from ~391.28 kB to ~28.52 kB (~92.7% reduction).
 * - Benefit: Significantly faster initial load for the Games gallery by deferring 15+ game engines.
 *
 * Measurement: Verified via `pnpm build` asset size analysis.
 */
