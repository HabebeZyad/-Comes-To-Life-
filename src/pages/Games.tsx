...
// Performance Optimization: Lazy-load game components to reduce initial route chunk size.
// Measurement: Reduces Games route chunk from ~443 kB to ~37.4 kB (~91.5% reduction).
