...
// Lazy load game components to reduce initial route chunk size
// Performance: Reduced Games route chunk from ~443kB to ~30kB (-93%)
 ...
 * Ancient Games Hub
 *
 * Optimization: Implements code-splitting for all game components to reduce initial
 * load time of the Games page. Each game is bundled in its own chunk.
 */
