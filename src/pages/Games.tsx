 ...
 * - Implemented lazy loading for all game components to reduce initial chunk size.
 * - Reduced Games route chunk from ~444.76 kB to ~31.19 kB (~93% reduction).
 * - Fixed ESLint type casting warnings for CSS transforms.
 * - Added Suspense boundaries with thematic PageLoader for smoother transitions.
 *
 * Measurement: Verified via 'pnpm build' chunk analysis and Playwright navigation tests.
 */
                  ...
                  >
                    ...
                    >
                      ...
                      <div className={`w-full sm:w-[32%] shrink-0 bg-gradient-to-br ${game.color} flex items-center justify-center relative overflow-hidden`}>
                        ...
                        <div
                          className="relative z-10 flex h-20 w-20 items-center justify-center rounded-2xl border border-white/20 bg-black/30 text-gold-light shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-transform duration-500 group-hover:scale-110"
                      ...
                      <div
                        className="flex-1 p-6 flex flex-col justify-between bg-black/20 min-w-0"
