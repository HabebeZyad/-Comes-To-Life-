...
/**
 * Lazy-loaded game components to improve initial bundle size and page load performance.
 *
 * PERFORMANCE IMPACT:
 * - Reduces the initial 'Games' page chunk size from ~259 kB to ~23 kB (a 91% reduction).
 * - Distributes heavy game logic and 3rd-party dependencies across multiple smaller, on-demand chunks.
 * - Improves Time to Interactive (TTI) and First Contentful Paint (FCP) for users entering the Games Hub.
 */
