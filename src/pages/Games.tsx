...
const GuessThePharaohGame = lazy(() => import('@/components/games/GuessThePharaohGame').then(m => ({ default: m.default })));
const PyramidTrailGame = lazy(() => import('@/components/games/PyramidTrailGame').then(m => ({ default: m.default })));
const OrderOfBuildersGame = lazy(() => import('@/components/games/OrderOfBuildersGame').then(m => ({ default: m.default })));
const GreatMindsGame = lazy(() => import('@/components/games/GreatMindsGame').then(m => ({ default: m.default })));
const ScribesLostJournalGame = lazy(() => import('@/components/games/ScribesLostJournalGame').then(m => ({ default: m.default })));
...
const LoadingFallback = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-hero-gradient text-white">
    ...
    <h2 className="text-2xl font-display text-gold-gradient">Loading Trial...</h2>
  </div>
);
