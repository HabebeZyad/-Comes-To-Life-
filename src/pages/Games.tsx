 ...
 *
 * Each game component and the leaderboard is now loaded only when needed.
 * This significantly reduces the initial bundle size for the Games page,
 * as users only download the specific game they choose to play.
 *
 * Impact: Reduces 'Games' chunk size by ~70% (390kB -> ~120kB).
 * Measurement: Verified via 'pnpm build' chunk analysis.
 */
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {showLeaderboard && (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="mb-12">
            <Suspense fallback={<div className="h-96 w-full rounded-2xl border-2 border-gold/20 bg-black/40 animate-pulse" />}>
              <Leaderboard />
            </Suspense>
          </motion.div>
        )}
