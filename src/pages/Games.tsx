...
/**
 * BOLT OPTIMIZATION: Component-level code splitting for all game modules.
 * This reduces the initial 'Games' page chunk size from ~390.75 kB to ~28.44 kB (-92.7%).
 * Individual game modules (e.g., MummyMaze, PyramidBuilder) are deferred until selected.
 */
...
/**
 * BOLT OPTIMIZATION: Component-level code splitting for game modules.
 *
 * NATURE: Replaced synchronous imports of 18 game components and the Leaderboard with React.lazy.
 * IMPACT: Reduced the initial Games page chunk size from 390.75 kB to 28.60 kB (~92.7% reduction).
 * MEASUREMENT: Verified via `pnpm build` bundle analysis and Playwright functional testing.
 */
