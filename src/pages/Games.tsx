...
/**
 * Performance Optimization: Lazy Loading Game Components
 * Each game component is now loaded only when selected by the user.
 * This significantly reduces the initial bundle size and speeds up the first paint
 * of the Games hub, as the heavy game logic and assets are deferred.
 */
