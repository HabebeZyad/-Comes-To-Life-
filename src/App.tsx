...
// Optimized: Route-level code splitting to reduce initial bundle size
...
const PageLoader = () => (
  <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4">
    ...
    <p className="font-display text-gold tracking-widest animate-pulse">LOADING CHRONICLES...</p>
  </div>
);
