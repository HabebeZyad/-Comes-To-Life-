 ...
 * Heavy 3D panorama viewer using Three.js, React Three Fiber, and Drei.
 * Extracted for lazy-loading to reduce initial bundle size for pages only using 'globe' mode.
 */
