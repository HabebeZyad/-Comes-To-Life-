...
interface ScryingOrbViewerProps {
  image: string;
}

/**
 * ScryingOrbViewer Component
 * Heavyweight 3D version of the ScryingOrb using Three.js and React Three Fiber.
 * Lazy-loaded to avoid bloating initial page bundles.
 */
export const ScryingOrbViewer = ({ image }: ScryingOrbViewerProps) => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
export default ScryingOrbViewer;
