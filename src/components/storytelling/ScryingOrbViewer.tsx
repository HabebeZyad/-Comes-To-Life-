...
/**
 * Viewer360 Component
 * Handles the 3D panorama logic using @react-three/fiber.
 */
 ...
 * The heavy Three.js-based component for the 360-degree heritage viewer.
 */
const ScryingOrbViewer = ({ image }: { image: string }) => {
    return (
        <motion.div
            key="viewer"
            initial={{ opacity: 0 }}
