 ...
 * Lightweight CSS and Framer Motion animation for the default 'globe' mode of the ScryingOrb.
 * Extracted to allow ScryingOrb to load Three.js dependencies only when needed for 'viewer' mode.
 */
