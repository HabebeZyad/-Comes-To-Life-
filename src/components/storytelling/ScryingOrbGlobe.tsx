 ...
 * Lightweight CSS/Framer Motion based representation of the Scrying Orb.
 * This component is used as the default view and as a fallback for the 3D viewer.
 * It ensures the initial page load remains fast by avoiding heavy 3D dependencies.
 */
const ScryingOrbGlobeComponent = () => {
  return (
    <motion.div
      key="globe"
      initial={{ opacity: 0 }}
...
export const ScryingOrbGlobe = memo(ScryingOrbGlobeComponent);
ScryingOrbGlobe.displayName = 'ScryingOrbGlobe';
