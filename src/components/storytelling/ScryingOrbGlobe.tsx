 ...
 * Lightweight CSS/Framer Motion implementation of the external "globe" view.
 * Isolated from Three.js dependencies to improve initial bundle size.
 */
...
export default ScryingOrbGlobe;
