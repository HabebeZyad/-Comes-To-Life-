 ...
 * A thematic loading screen used as a Suspense fallback for lazy-loaded pages and components.
 * Extracted to a shared component to enable reuse across the application.
 */
